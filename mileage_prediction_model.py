...
Original file is located at
    https://colab.research.google.com/drive/1mt53C6X1hQjqjmsGDGai8MixvKsr9OT6
...
In this model, we used Linear Regression Model or OLS method to solve the problem because mileage prediction problem is a Regression Problem.
...
This equation Gives us a model with aproxximately 85% of accuracy and about 15% error.
